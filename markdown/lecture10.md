...
Apply Separation of Concerns by transforming poorly organized code into a clean structure.

---

## Step 1: Given Messy Code
...
3. Create a separate CSS section/file.
4. Create a separate JavaScript section/file.
5. Keep HTML responsible only for structure.
